...
def pseudo_main(args):
    ...
    """ passing mark, everything above passes """
...
if __name__ == '__main__':
    ...
    parser.add_argument('-ep_l', "--epochs_low", help='Number of epochs in low neped training (pre-transfer)', type=int,default=25)
    parser.add_argument('-ep_h', "--epochs_high", help='Number of epochs in low neped training (pre-transfer)', type=int,default=25)
