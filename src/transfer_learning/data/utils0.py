...
from sklearn.preprocessing import StandardScaler, RobustScaler # to scale data between 0 and 1
...
def load_data_torch(random_st=42, neped_split = 9.5, n_samples = 15, scale = True, **kwargs):
        ...
        if kwargs.get('data_loc'):
                ...
                filename = '/home/adam/ENR_Sven/data-general/seperatrix_dataset.csv'
        ...
        if scale:
                ...
                # df[target] = RS.fit_transform(df[target])
