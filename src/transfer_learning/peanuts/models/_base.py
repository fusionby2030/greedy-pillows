...
class BaseTorchModel(nn.Module):
    ...
    """
    def __init__(self, estimator, n_estimators, hidden_layer_sizes=None, estimator_args=None):
        super(BaseTorchModel, self).__init__()
        self.base_estimator_ = estimator
        self.n_estimators = n_estimators
        self.estimator_args = estimator_args
        self.hidden_layer_sizes = estimator_args['hidden_layer_sizes']

        self.estimators_ = nn.ModuleList()
        self.logger = logging.getLogger("nni")
