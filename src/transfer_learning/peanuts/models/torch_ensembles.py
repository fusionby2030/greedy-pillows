...
class AverageTorchRegressor(BaseTorchRegressor):
    ...
    def fit(self, train_loader, epochs=150, log_interval=25, test_loader=None, save_model=True, save_dir=None, cache_save=True):
        ...
        for epoch in range(epochs):
            ...
            for batch_idx, (control, target) in enumerate(train_loader):
                ...
                optimizer.zero_grad()
                output = self.forward(control).squeeze(1)
                # print(output, target)
            ...
            if test_loader:
                ...
                with torch.no_grad():
                    ...
                    # print(msg.format(epoch, mse, best_mse))
